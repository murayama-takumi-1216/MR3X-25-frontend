...
import { paymentsAPI, propertiesAPI, usersAPI } from '@/lib/api'
...
import { Download, TrendingUp, TrendingDown, DollarSign, Building2, Users, Calendar, FileText } from 'lucide-react'
...
export default function ReportsPage() {
  ...
  // Calculate overdue payments (mock data for now)
  const overduePayments = 0
  const delinquencyRate = 0
