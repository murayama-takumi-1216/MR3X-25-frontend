...
export default function ChangePasswordPage() {
  ...
  const changePasswordMutation = useMutation({
    ...
    onError: (error: any) => {
      toast.error(error?.message || 'Não foi possível alterar a senha. Verifique os dados informados.')
    },
  })
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-start gap-3 rounded-md border border-border bg-muted/40 p-3 text-sm text-muted-foreground">
                ...
                <div>
                  Utilize uma senha forte com pelo menos 6 caracteres. Evite reutilizar senhas anteriores ou informações fáceis de adivinhar.
                </div>
              </div>
